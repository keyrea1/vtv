...
export default class StaticTActionsWagon extends JetView {
	config () {
		...
		const datatable_name = "static_operations_wagon";
		...
		function delWeight (id) {
			...
			webix.ajax().post(
				...
				function (text, xml, xhr) {
					...
					if (data.method === _methodName) {
						if (data.answer === "ok") {
							$$('static_operations_wagon').remove(id);
		...
		function setArchive (id) {
			...
			webix.ajax().post(
				...
				function (text, xml, xhr) {
					...
					if (data.method === _methodName) {
						if (data.answer === "ok") {
							var obj = $$('static_operations_wagon').getItem(id);
							$$('static_operations_wagon').remove(id);
		...
		if (access.change_wagon_number)
			wagonNumberField = {
				id: "wagon_number", header: _("wagon_number"),
				adjust: "header", editor: "text", format: function (value) {
				...
				template: function (obj) {
					if (obj.axels_count === undefined || obj.axels_count === null || obj.axels_count === '') {
						if (obj.wagon_number === null) return '';
		...
		return {
			...
			columns: [
				...
				{
					id: "train_number", header: _("train_number"), adjust: "header",
				...
				wagonNumberField,
				{
					...
					template: function (obj) {
						if (obj.start_weight >= obj.capacity && obj.start_weight !== null && obj.capacity !== null && obj.start_weight !== undefined && obj.capacity !== undefined) {
							$$(datatable_name).addRowCss(obj.id, "badRow");
							return "<span style='color:red;font-size: 140%;'>" + obj.start_weight + "</span>";
						}
						else if (obj.capacity - obj.start_weight <= 10 && obj.start_weight !== null && obj.capacity !== null && obj.start_weight !== undefined && obj.capacity !== undefined) {
							$$(datatable_name).addRowCss(obj.id, "warnRow");
							return "<span style='color:yellow;font-size: 140%;'>" + obj.start_weight + "</span>";
						}
						else if (obj.start_weight !== null && obj.start_weight !== undefined && !isNaN(obj.start_weight)) return obj.start_weight;
						else return '';
					}
				},
				{
					...
					template: function (obj) {
						if (obj.doc_start_weight >= obj.capacity && obj.doc_start_weight !== null && obj.capacity !== null && obj.doc_start_weight !== undefined && obj.capacity !== undefined) {
							$$(datatable_name).addRowCss(obj.id, "badRow");
							return "<span style='color:red;font-size: 140%;'>" + obj.doc_start_weight + "</span>";
						}
						else if (obj.capacity - obj.doc_start_weight <= 10 && obj.doc_start_weight !== null && obj.capacity !== null && obj.doc_start_weight !== undefined && obj.capacity !== undefined) {
							$$(datatable_name).addRowCss(obj.id, "warnRow");
							return "<span style='color:yellow;font-size: 140%;'>" + obj.doc_start_weight + "</span>";
						}
						else if (obj.doc_start_weight !== null && obj.doc_start_weight !== undefined) return obj.doc_start_weight;
						else return '';
					}
				},
				{
					...
					template: function (obj) {
						if ((obj.cargo_weight || obj.doc_cargo_weight) && obj.start_weight && obj.doc_start_weight && obj.brutto && (obj.capacity - obj.brutto > 10) && obj.side_diff < configuration["side_diff"] && obj.offset_lengthwise < configuration["offset_lengthwise"] && obj.cross_offset < configuration["cross_offset"]) {
							$$(datatable_name).addRowCss(obj.id, "goodRow");
						}
						if (obj.brutto === null || obj.brutto === undefined || isNaN(obj.brutto)) return "";
						else return obj.brutto;
					}
				},
				...
				{id: "doc_date", header: _("doc_date"), editor: "date", sort: "date", format: dateFormat, adjust: true},
				{id: "cargo_name", header: _("cargo_name"), editor: "text", suggest: cargoNameSuggester, adjust: true},
				...
				{//19
					...
					adjust: true, math: "[$r,truck2_weight] - [$r,truck1_weight]",
					template: function (obj) {
				...
				{id: "sender", header: _("sender"), editor: "myeditor2", adjust: true, liveEdit: true},
				{id: "reciever", header: _("reciever"), editor: "myeditor2", adjust: true},
				{id: "transporter", header: _("transporter"), editor: "myeditor2", adjust: true},
				{
					id: "departure_point",
				...
				{id: "cargo", header: _("cargo"), editor: "text", suggest: cargoSuggester, adjust: true},
				...
				{
					id: "save", header: "", adjust: true, hidden: !access.adding_arch_data,
					template: function (obj) {
			...
			on: {
				"onAfterEditStop": function (state, editor, ignoreUpdate) {
					var row = editor.row;
					try {
						var obj = $$('static_operations_wagon').getItem(row);
					}
					catch (e) {
						console.log(e);
						return false;
					...
					if (editor.column === "doc_cargo_weight") {
                        ...
                        if (obj.doc_cargo_weight < 0) obj.doc_cargo_weight = -obj.doc_cargo_weight
					...
					if (id.column === "save") {
						...
						if ((obj.cargo_weight || obj.doc_cargo_weight) && (obj.start_weight || obj.doc_start_weight) && obj.brutto) {
							if ((obj.capacity - obj.start_weight >= 0 && obj.start_weight !== null)|| (obj.capacity - obj.doc_start_weight >= 0 && obj.doc_start_weight !== null)) {
								//TODO: WARNING ABOUT CROSS OFFSET AND OFFSET LENGHTWISE
								if (obj.wagon_number) {
									setArchive(obj.id);
			...
			rightSplit: access.adding_arch_data
		};
	}
	...
	init (grid) {
		...
		function getOperationTable () {
			...
			webix.ajax().post(
				ip, {"method": "getOperationTable", "user": User, "params": {"type": "static.wagon"}},
				function (text, xml, xhr) {
					var data = JSON.parse(text);
					console.log(data);
					if (data.method === _methodName) {
